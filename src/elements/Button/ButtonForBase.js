...
import { componentPropType } from 'elements/utils'
import injectSheet from 'react-jss'
import { fade } from 'theme/styles/colorManipulator'
import ButtonBase from 'elements/ButtonBase'
import chainPropTypes from 'elements/utils/chainPropTypes'
import { capitalize } from 'elements/utils/helpers'
...
export const styles = theme => ({
  ...
  root: {
    ...
    '&:hover': {
      textDecoration: 'none',
      backgroundColor: fade(theme.typography.color.light, theme.palette.action.hoverOpacity),
  ...
  textPrimary: {
    ...
    '&:hover': {
      backgroundColor: fade(theme.typography.color.dark, theme.palette.action.hoverOpacity),
      // Reset on touch devices, it doesn't add specificity
      '@media (hover: none)': {
        backgroundColor: 'transparent',
      },
  ...
  outlinedPrimary: {
    color: theme.typography.color.dark,
    border: `1px solid ${fade(theme.typography.color.dark, 0.5)}`,
    '&:hover': {
  ...
  containedPrimary: {
    color: '#fff',
    backgroundColor: theme.typography.color.dark,
    '&:hover': {
      backgroundColor: '#000',
      // Reset on touch devices, it doesn't add specificity
      '@media (hover: none)': {
  ...
  sizeSmall: {
    ...
    minWidth: 64,
    minHeight: 32,
    fontSize: '1rem', // theme.typography.pxToRem(13),
  },
